...
where pm.prop_id=pr.prop_id and a.area_id=pm.area_id and c.cat_id=pm.cat_id and b.builder_id=pm.builder_id and pm.prop_id=$id"));
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="contact-realtor-wrapper">
                        <div class="realtor-info">
                            <img src="img/bg-img/<?php echo $result[18]; ?>" alt="">
                            <div class="realtor---info">
