            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">Flat</h3>
                    </div>
                </div>
            </div>
        </div>
...
where pm.prop_id=pr.prop_id and a.area_id=pm.area_id and c.cat_id=pm.cat_id and b.builder_id=pm.builder_id and cat_name='flat' ");
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50">
                        ...
                        <div class="property-thumb">
                            <a href="single_flat.php?no=<?php echo $r[0]; ?>"> <img src="img\bg-img\home\<?php echo $r[21]; ?>" height="500px" width="500px"  alt="">
