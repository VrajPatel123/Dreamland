...
where pm.prop_id=pr.prop_id and a.area_id=pm.area_id and c.cat_id=pm.cat_id and b.builder_id=pm.builder_id and cat_name='home'  and pm.prop_id=$id"));
?>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-8">
                    <div class="listings-content">
                        ...
                        <p class="location">
                            <img src="img/icons/location.png" alt=""><?php echo $result[8]; ?>
                        </p>
