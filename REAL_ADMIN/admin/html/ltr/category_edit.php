...
$r=mysqli_fetch_row(mysqli_query($cn,"select * from CATEGORY where cat_id=$no"));
...
if(isset($_POST['b1']))
{
    ...
    mysqli_query($cn,"UPDATE category set cat_name='$name',cat_type='$type' where cat_id=$no");
			...
			<div class="card">
				...
				<div class="card-body collapse in">
					<div class="card-block">
										...
										<form class="form" action=""  method="post" style="font-size: 17px">
							<div class="row">
								<div class="col-md-6 offset-md-3">
									<div class="form-body">
										<div class="form-group">
											<label for="eventInput1">Category Id</label>
											<input type="text" id="Catid" class="form-control" required title="Please enter id" pattern="[0-9]*" readonly="readonly" placeholder="Category id" name="Category_id"  value=<?php echo $r[0]; ?> >
										</div>

										<div class="form-group">
											<label for="eventInput2">Category Name </label>
											<input type="text" id="catname" class="form-control" required title="Please Enter CATEGORY Name" pattern="[A-Za-z]*"  placeholder="Enter Category Name" name="catname" value=<?php echo $r[1]; ?> >
										</div>

										<div class="form-group">
											<label for="eventInput3">Category Type</label>
											<select  id="cattype" class="form-control"  required title="Enter type" placeholder="company" name="cattype" >
											<option value="">-----Select category type-------</option>
											<option value="rent" <?php if ($r[2]=="rent") { ?> selected="selected" <?php } ?>>Rent</option>
											<option value="buy" <?php if ($r[2]=="buy") { ?> selected="selected" <?php } ?>>Buy</option>
											<option value="sell" <?php if ($r[2]=="sell") { ?> selected="selected" <?php } ?>>Sell</option>
											</select>
