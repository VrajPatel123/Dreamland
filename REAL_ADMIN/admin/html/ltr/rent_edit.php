...
<section id="basic-form-layouts" style="font-size: 17px">
         ...
         <form class="form" method="post" name="f1" action="" enctype="multipart/form-data">
              ...
              <div class="form-body">
                    <div class="form-group">
                      ...
                      <input type="text" id="pname" class="form-control" required title="Please enter name" pattern="[A-za-z]*" placeholder="Enter property name" name="pname" value="<?php echo $result3[6]; ?>">
              </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <textarea id="projectinput4" rows="5" class="form-control" required title="Enter Farmer Address" pattern="[a-zA-Z0-9 ,-]*" name="address" placeholder="Address"  value=""><?php echo $result3[13]; ?></textarea>
                </div>
