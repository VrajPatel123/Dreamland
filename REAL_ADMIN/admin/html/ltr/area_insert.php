...
else
{
	...
	if(isset($_POST['b1']))
	{
		...
		mysqli_query($cn,"insert into area (area_name) values('$aname')");
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form-center">Insert Area</h4>
								...
								<div class="col-md-6 offset-md-3">
									<div class="form-body">
										<div class="form-group">
											...
											<input type="text" id="areaname" class="form-control" required title="Please enter name" pattern="[A-za-z]*" placeholder="Enter Area Name" name="areaname">
										</div>
									</div>
								</div>
							</div>
