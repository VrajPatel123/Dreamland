...
$email=$_SESSION['email'];
	...
	if(isset($_POST['b1']))
	{
		...
		mysqli_query($cn,"insert into property_rent_detail values ($pname,'$p1','$p2','$p3','$p4','$p5','$address',$price,$sqft,$bedrooms,$parking,$bathrooms,'$buildyear','$desc','$ac','$clubhouse','$cityview','$intercom',	'$internet','$laundryroom','$erange','$gas','$swimmingpool','$floorimage','$video','$locationimg',$floor)");
		echo "inserted";	
	}
?>
