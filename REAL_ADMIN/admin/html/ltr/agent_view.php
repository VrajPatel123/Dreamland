...
$cn=mysqli_connect('localhost','root','') or die('  not connected');
  ...
  $productResult = $db_handle->runQuery("select * from agent");
...
function agentdel(id)
{
    if (window.XMLHttpRequest) {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("agentdel").innerHTML = this.responseText;
             }
        };
        xmlhttp.open("GET","agent_ajax_del.php?row_id="+id,true);
        xmlhttp.send();
}
</script>
  </head>
          ...
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            <ul class="nav navbar-nav">
             ...
             <ul class="nav navbar-nav float-xs-right">
              ...
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="../../app-assets/images/logo/vraj(1).jpg" alt="avatar" ><i></i></span><span class="user-name"><h3><?php echo $uname; ?></h3></span></a>
...
<section id="basic-form-layouts">
 ...
 <h6> <div class="row match-height" style="font-size: 15px">
    <div class="col-md-20">
      <div class="card">
        ...
        <br>
             ...
             ?>
              ...
              <td ><input type="button" name="b2" value="delete" onClick="agentdel('<?php echo $r[0];?>')"></td>
                 <td ><a href="agent_edit.php?id=<?php echo $r[0]; ?>"><input type="button" name="b1" value="update" /></a></td>
              <td> <?php echo $r[0]; ?> </td>
              <td> <?php echo $r[1]; ?> </td>
              <td> <?php echo $r[2]; ?> </td>
              <td> <?php echo $r[3]; ?> </td>
