...
if(isset($_POST['b1']))
    {
        ...
        {
            $area_id=$checkbox[$i];
            mysqli_query($cn,"DELETE FROM area WHERE area_id='".$area_id."'");    
        }
    }
  }
    ...
    if (window.XMLHttpRequest) {
        ...
        xmlhttp.onreadystatechange = function() {
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                document.getElementById("areadel").innerHTML = this.responseText;
             }
        };
        xmlhttp.open("GET","area_ajax_del.php?row_id="+id,true);
        xmlhttp.send();
}
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form-center">Delete Area</h4>
				...
				<div class="card-body collapse in" >
					<div class="card-block" id="areadel">
