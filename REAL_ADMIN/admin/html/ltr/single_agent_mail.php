...
$result=mysqli_query($cn,"select email_id from user_registration");
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">MAIL</h2>
          </div>
				...
				<div class="card-body collapse in">
                  ...
                  <strong>
							...
							<div class="row">
                                ...
                                <input type="text" class="form-control" name="subject" id="contact-email" placeholder="Your subject">
                            </div>
							...
							<div class="form-actions center">
								<input type="submit" class="btn btn-primary" name="btnmail" id="contact-email" value="Send Mail">
