...
$r=mysqli_fetch_row(mysqli_query($cn,"select * from builder where builder_id=$no"));
...
if(isset($_POST['b1']))
{
    ...
    {
          $bphoto=$_FILES['p21']['name'];
    }
  
  
    $address=$_POST['address'];
     
    mysqli_query($cn,"UPDATE builder set builder_name='$name',company_name='$cname',company_logo='$clogo',email_id='$email',mobile=$phone,builder_photo='$bphoto',office_address='$address' where builder_id=$no") or die("no");
    header('location:builder_view.php');
      ...
      <div class="navbar-wrapper">
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            <ul class="nav navbar-nav">
              <li class="nav-item hidden-sm-down"><a class="nav-link nav-menu-main menu-toggle hidden-xs"><i class="icon-menu5">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form-center">Edit Builder</h4>
								...
								<div class="col-md-6 offset-md-3">
									<div class="form-body">
										...
										<div class="form-group">
											<label for="eventInput1">Builder Id</label>
											<input type="text" id="builderid" class="form-control" readonly="readonly"  placeholder="Builder id" name="Builder_id" value=<?php echo $r[0]; ?>>
										</div>

									
										<div class="form-group">
											<label for="eventInput1">Builder Name</label>
											<input type="text" id="buildername" class="form-control" required title="Please enter name" pattern="[A-z a-z]*" placeholder="Enter Builder Name" name="name" value=<?php echo $r[1]; ?>>
										</div>
								
								<div class="form-group">
									<label for="eventRegInput3">Company Name</label>
									<input type="text" id="eventRegInput3" class="form-control" required title="Please enter name" pattern="[A-za-z]*" placeholder="company name" name="cname" value=<?php echo $r[2]; ?>>
								</div>
		
							<div class="form-group">
									<label>Company Logo</label>
									<label id="projectinput4" class="file center-block">
                    <input type="file" id="file" name="p11" required title="Select company  Photo">
                    <input type="text" id="file" name="p12"  value="<?php echo $r[3]; ?>" />
								...
								<div class="row">
										<div class="col-md-7">
										<div class="form-group">
											<label for="projectinput5">E-mail</label>
											<input type="text" id="projectinput7" class="form-control" required pattern="^\S+@\S+\.\S+$" title="example@mail.com"  placeholder="E-mail" name="email" value=<?php echo $r[4]; ?>>
										</div>
									</div>
									</div>
									<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											...
											<input type="text" id="projectinput6" class="form-control" required minlength="10" maxlength="10" pattern="[0-9]*" title="Enter  Mobile Number" placeholder="Phone" name="phone" value=<?php echo $r[5]; ?>>
										</div>
									</div>
								</div>
								<div class="form-group">
									<label>Builder Photo</label>
									<label id="projectinput7" class="file center-block" >
                  	<input type="file" id="file" name="p21" required title="Select builder Photo" >
                    <input type="text" id="file" name="p22"  value="<?php echo $r[6]; ?>" />
										<span class="file-custom"></span>
									</label>
								</div>
                  	<div class="form-group">
									<label for="projectinput4"> Office Address</label>
									<textarea id="projectinput4" rows="5" class="form-control" required title="Enter  Address" pattern="[a-zA-Z0-9 ,-]*" name="address" placeholder="Address"   value=""><?php echo $r[7]; ?></textarea>
								</div>
							</div>
