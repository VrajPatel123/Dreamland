...
else
{
	...
	if(isset($_POST['b1']))
	{
		$name=$_POST['catname'];
		$type=$_POST['cattype'];
		mysqli_query($cn,"insert into category (cat_name,cat_type)values('$name','$type')");
		echo "inserd";	
	}
}
?>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form-center">Insert Category</h4>
				...
				<div class="card-body collapse in">
					<div class="card-block">
										...
										<form class="form" action=""  method="post" name="f1"  enctype="multipart/form-data" >
							<div class="row">
								<div class="col-md-6 offset-md-3">
									<div class="form-body">
										<div class="form-group">
											<label for="eventInput1">Category Name</label>
											<input type="text" id="catname" class="form-control"  required title="Please Enter CATEGORY Name" pattern="[ A-Z a-z]*"placeholder="Enter Category Name" name="catname">
										</div>

										<div class="form-group">
											<label for="eventInput2">Category Type</label>
											<select id="cattype" class="form-control"  required title="Enter type" placeholder="title" name="cattype">
