...
$email=$_SESSION['email'];
	...
	if(isset($_POST['b1']))
	{
		...
		mysqli_query($cn,"insert into property_rent_detail values ($prop_id,'$p1','$p2','$p3','$p4','$p5','$address',$price,$sqft,$bedrooms,$parking,$bathrooms,'$buildyear','$desc','$ac','$clubhouse','$cityview','$intercom',	'$internet','$laundryroom','$erange','$gas','$swimmingpool','$floorimage','$video','$locationimg',$floor)");
		echo "inserted";	
	}
}
?>
			...
			<div class="card">
				...
				<div class="card-body collapse in">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" id="price" class="form-control" required title="Please enter  builder name" pattern="[A-z a-z]*" placeholder="Enter property name" name="pname">
              </div>
              </div>
                  ...
                  <label>Photo 1</label>
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file" name="p1"  required title="Select   Photo">
                    <span class="file-custom"></span>
                  </label>
                </div>
              ...
              <div class="form-group">
                  <label>Photo 2</label>
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file" name="p2"  required title="Select   Photo">
                    <span class="file-custom"></span>
                  </label>
                </div>
                ...
                <div class="form-group">
                  <label>Photo 3</label>
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file" name="p3"  required title="Select   Photo">
                    <span class="file-custom"></span>
                  </label>
                </div>
                ...
                <div class="form-group">
                  <label>Photo 4</label>
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file" name="p4"  required title="Select   Photo">
                    <span class="file-custom"></span>
                  </label>
                </div>
                ...
                <div class="form-group">
                  <label>Photo 5</label>
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file" name="p5"  required title="Select   Photo">
                    <span class="file-custom"></span>
                  </label>
                </div>
                ...
                <div class="form-group">
                  ...
                  <textarea id="projectinput4" rows="5" class="form-control"  required title="Enter  Address" pattern="[a-z A-Z 0-9 ,-]*" name="address" placeholder="Address"></textarea>
                </div>
              ...
              <div class="form-body">
                    <div class="form-group">
                      ...
                      <input type="text" id="price" class="form-control" required title="Enter price" placeholder="Enter Price" name="price">
              </div>
              </div>
              ...
              <div class="form-body">
                    <div class="form-group">
                      ...
                      <input type="text" id="price" class="form-control" required="enter Sqare foot" placeholder="Enter Sqare foot" name="sqft">
              </div>
              </div>
              ...
              <div class="row">
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <select id="projectinput5" name="bedrooms" class="form-control" required="select option">
              ...
              <div class="row">
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <select id="projectinput5" name="bathrooms" class="form-control" required="">
                ...
                <div class="form-group">
                  ...
                  <div class="position-relative has-icon-left">
                    <input type="date" id="timesheetinput3" class="form-control" required title="enter valid date" name="buildyear">
              ...
              <div class="row">
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <select id="projectinput5" name="desc" class="form-control" required="">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="ac" class="custom-control-input" required="select"  value="yes">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="ac"  class="custom-control-input" required="select"  value="no">
                      <span class="custom-control-indicator"></span>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="clubhouse" class="custom-control-input" required="select" value="yes">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="clubhouse"  class="custom-control-input"  required="select" value="no">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="cityview" class="custom-control-input" required="select"  value="yes">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="cityview"  class="custom-control-input" required="" value="no">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="intercom" class="custom-control-input" required="" value="yes">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="intercom"  class="custom-control-input" required="select"  value="no">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="internet" class="custom-control-input" required="" value="yes">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="internet"  class="custom-control-input" required="" value="no">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="laundryroom" class="custom-control-input" required="" value="yes">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="laundryroom"  class="custom-control-input"  required="" value="no">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="erange" class="custom-control-input" required="" value="yes">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="erange"  class="custom-control-input" required="" value="no">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="gas" class="custom-control-input" required="" value="yes">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="gas"  class="custom-control-input" required="" value="no">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="swimmingpool" class="custom-control-input"  required="" value="yes">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="swimmingpool"  class="custom-control-input" required="" value="no">
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <label id="projectinput7" class="file center-block" >
                    <input type="file" id="file" name="floorimage"  required title="Select  Photo">
                    <span class="file-custom"></span>
                  </label>
                </div>
                ...
                <div class="form-group">
                  <label>video</label>
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file" name="video"  required title="Select  Photo">
                    <span class="file-custom"></span>
                  </label>
                </div>
                ...
                <div class="form-group">
                  ...
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file" name="locationimg"  required title="Select Photo">
                    <span class="file-custom"></span>
                  </label>
                </div>
                ...
                <div class="row">
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <select id="projectinput5" name="floor" class="form-control" required="">
