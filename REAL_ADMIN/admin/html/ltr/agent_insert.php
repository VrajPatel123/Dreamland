		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form-center">Insert Agent</h4>
				...
				<div class="card-body collapse in">
					<div class="card-block">
										<form class="form" method="post" name="f1" action="agent_insert.php" enctype="multipart/form-data">
								...
								<div class="col-md-6 offset-md-3">
									<div class="form-body">
										<div class="form-group">
											...
											<input type="text" id="agentname" class="form-control" required title="Please enter name" pattern="[A-z a-z]*" placeholder="Enter agent Name" name="agentname">
										</div>
										<div class="form-group">
									<label>Gender</label>
									<div class="input-group">
										<label class="display-inline-block custom-control custom-radio ml-1">
											<input type="radio" name="r1" class="custom-control-input" required="select" value="Male" >
											<span class="custom-control-indicator"></span>
											<span class="custom-control-description ml-0" >Male</span>
										</label>
										<label class="display-inline-block custom-control custom-radio">
											<input type="radio" name="r1"  class="custom-control-input" required="select" value="Female">
											<span class="custom-control-indicator"></span>
							...
							<div class="form-group">
									...
									<div class="position-relative has-icon-left">
										<input type="date" id="timesheetinput3" class="form-control" required title="enter valid date" name="dob">
									...
									<textarea id="projectinput4" rows="5" class="form-control" required title="Enter  Address" pattern="[a-z A-Z0-9 ,-]*" name="address" placeholder="Address"></textarea>
								</div>
						...
						<div class="row">
									<div class="col-md-5">
										<div class="form-group">
											...
											<select id="projectinput5" name="city" class="form-control" required title="enter city">
									...
									<div class="col-md-7">
										<div class="form-group">
											...
											<input type="text" id="projectinput6" class="form-control" required minlength="10" maxlength="10" pattern="[0-9]*" title="Enter  Mobile Number" placeholder="Phone" name="mobile">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											...
											<input type="text" id="projectinput7" class="form-control" required pattern="^\S+@\S+\.\S+$" title="example@mail.com"  placeholder="E-mail" name="email">
										</div>
									</div>
									</div>
									...
									<div class="col-md-7">
										<div class="form-group">
											...
											<input type="password" id="projectinput7" class="form-control" required="password" placeholder="Password" placeholder="Password" name="pwd">
										</div>
									</div>
									</div>
							...
							<div class="form-group">
									...
									<label id="projectinput7" class="file center-block" >
										<input type="file" id="file" name="aphoto" required title="Select Agent  Photo">
								...
								<div class="form-group">
									...
									<input type="text" id="eventRegInput3" class="form-control" required title="Please enter name" pattern="[ A-za-z]*"  placeholder="company name" name="cname">
								</div>
								...
								<div class="form-group">
									...
									<label id="projectinput7" class="file center-block" >
										<input type="file" id="file" name="clogo" required title="Select company logo">
										<span class="file-custom"></span>
									</label>
								</div>
                ...
                <div class="form-group">
                  ...
                  <select id="issueinput6" name="question" class="form-control" required title="select question" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Status">
                      ...
                      <option value="Your Nickname">Your Nick Name?</option>
							...
							<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											...
											<input type="text" id="projectinput7" class="form-control" required title="Please enter name" pattern="[A-za-z]*"  placeholder="Answer" name="answer">
										</div>
									</div>
									</div>
...
try{
  if(isset($_POST['b1']))
  {
    ...
    mysqli_query($cn,"insert into agent (agent_name,gender,dob,address,city,mobile,email_id,password,agent_photo,company_name,company_logo,security_question,answer)values('$name','$gender','$dob','$address','$city',$mobile,'$email','$pwd','$aphoto','$cname','$clogo','$question','$answer')");
    //echo "inserted";  
...
$mail->Password = "vrajpatel123";
  ...
  $message=$name.' your registration is succesgfully';
