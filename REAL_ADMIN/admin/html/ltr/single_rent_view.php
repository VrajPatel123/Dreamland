      ...
      <div class="card">
        ...
        <div class="card-body collapse in">
          ...
          <table class="table">
              ...
              $result=mysqli_query($cn,"select * from property_master pm,property_rent_detail pd,agent a where pm.prop_id=pd.prop_id and a.email_id=pm.email_id and a.agent_name='$uname'");
              while($r=mysqli_fetch_array($result))
              {
            ?>
             <tr>
      <td ><input type="button" name="b2" value="delete" onClick="propdel('<?php echo $r[0];?>')"></td>
        <td ><a href="single_rent_edit.php?id=<?php echo $r[0]; ?>"><input type="button" name="b1" value="update" /></a></td>
              <td> <?php echo $r[0]; ?> </td>
              <td> <?php echo $r[1]; ?> </td>
              <td> <?php echo $r[2]; ?> </td>
              <td> <?php echo $r[3]; ?> </td>
