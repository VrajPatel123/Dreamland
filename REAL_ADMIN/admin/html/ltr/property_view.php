...
function propdel(id)
{
    if (window.XMLHttpRequest) {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("propdel").innerHTML = this.responseText;
             }
        };
        xmlhttp.open("GET","property_ajax_del.php?row_id="+id,true);
        xmlhttp.send();
}
        ...
        <div class="navbar-container content container-fluid">
          <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="../../app-assets/images/logo/vraj(1).jpg" alt="avatar" ></span><span class="user-name"><?php echo $uname; ?></span></a>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" id="basic-layout-form-center"> Property View</h4>
        ...
        <div class="card-body collapse in">
          ...
          <table class="table">
              ...
              $result=mysqli_query($cn,"select * from property_master pm,property_detail pd where pm.prop_id=pd.prop_id");
      ...
      <td ><input type="button" name="b2" value="delete" onClick="propdel('<?php echo $r[0];?>')"></td>
        <td ><a href="property_edit.php?id=<?php echo $r[0]; ?>"><input type="button" name="b1" value="update" /></a></td>
