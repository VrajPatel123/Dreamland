...
$r=mysqli_fetch_row(mysqli_query($cn,"select * from area where area_id=$no"));
  ...
  if(isset($_POST['b1']))
  {
   ...
   mysqli_query($cn,"UPDATE area set area_name='$aname' where area_id=$no");
...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="60x60" href="../../data-collapse="../../app-assets/images/logo/logo.png height="50" width="auto" >
    <link rel="apple-touch-icon" sizes="76x76" href="../../data-collapse="../../app-assets/images/logo/logo.png height="50" width="auto">
    <link rel="apple-touch-icon" sizes="120x120" href="../../data-collapse="../../app-assets/images/logo/logo.png height="50" width="auto">
    <link rel="apple-touch-icon" sizes="152x152" href="../../data-collapse="../../app-assets/images/logo/logo.png height="50" width="auto">
    <link rel="shortcut icon" type="image/x-icon" href="../../data-collapse="../../app-assets/images/logo/logo.png height="50" width="auto">
    <link rel="shortcut icon" type="image/png" href="../../data-collapse="../../app-assets/images/logo/logo.png height="50" width="auto">
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form-center">Edit Area</h4>
								...
								<div class="col-md-6 offset-md-3">
									<div class="form-body">
										<div class="form-group">
											<label for="eventInput1">Area Id</label>
											<input type="text" id="areaid" class="form-control" readonly="readonly"  placeholder="Enter Area Id" name="area_id"  value=<?php echo $r[0]; ?> >
										</div>
												<div class="form-group">
											<label for="eventInput2">Area Name </label>
											<input type="text" id="areaname" class="form-control" required title="Please enter name" pattern="[A-za-z]*" placeholder="Enter Area Name" name="area_name"  value=<?php echo $r[1]; ?> >
										</div>
