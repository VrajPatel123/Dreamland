...
<?php
	...
	if(isset($_POST['b1']))
	{
		...
		mysqli_query($cn,"insert into builder (builder_name,company_name,company_logo,email_id,mobile,builder_photo,office_address)values('$name','$cname','$clogo','$email',$phone,'$bphoto','$address')");
		echo "inserted";	
	}
}
?>
		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form-center">Insert Builder</h4>
								...
								<div class="col-md-6 offset-md-3">
									<div class="form-body">
										<div class="form-group">
											...
											<input type="text" id="buildername" class="form-control" required title="Please enter  builder name" pattern="[A-z a-z]*" placeholder="Enter Builder Name" name="buildername">
										</div>
								
								<div class="form-group">
									<label for="eventRegInput3">Company Name</label>
									<input type="text" id="eventRegInput3" class="form-control" required title="Please company name" pattern="[A-z a-z]*" placeholder="company name" name="companyname">
								</div>
		
							<div class="form-group">
									<label>Company Logo</label>
									<label id="projectinput7" class="file center-block">
										<input type="file" id="file" name="clogo"  required title="Select company  Photo">
								...
								<div class="row">
									...
									<div class="col-md-7">
										<div class="form-group">
											...
											<input type="text" id="projectinput6" class="form-control" required minlength="10" maxlength="10" pattern="[0-9]*" title="Enter  Mobile Number" placeholder="Phone" name="phone">
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<label id="projectinput7" class="file center-block">
										<input type="file" id="file" name="bphoto" required title="Select builder Photo" >
										<span class="file-custom"></span>
									</label>
								</div>
									...
									<textarea id="projectinput4" rows="5" class="form-control" required title="Enter  Address" pattern="[a-zA-Z0-9 ,-]*" name="address" placeholder="Address"></textarea>
								</div>
							</div>
