      ...
      <div class="card">
        ...
        <div class="card-body collapse in">
          ...
          <table class="table">
              ...
              $result=mysqli_query($cn,"select * from agent a,property_master pm,property_detail pd
where pd.prop_id=pm.prop_id and a.email_id=pm.email_id and a.agent_name='$uname'");
              while($r=mysqli_fetch_array($result))
              {
            ?>
             <tr>
      <td ><input type="button" name="b2" value="delete" onClick="propdel('<?php echo $r[14];?>')"></td>
        <td ><a href="single_property_edit.php?id=<?php echo $r[14]; ?>"><input type="button" name="b1" value="update" /></a></td>
