...
$email=$_SESSION['email'];
	...
	if(isset($_POST['b1']))
    {
        ...
        mysqli_query($cn,"insert into Advertisement (adv_name,adv_desc,company_name,company_desc,company_address,company_website,company_logo,status,post_date)values('$adv_name','$adv_desc','$company_name','$company_desc','$company_address','$company_website','$c_logo','$status','$post_date')")or die("hii");
        echo "inserted";  
    }
  }
      ...
      <div class="content-wrapper">
        <div class="content-header row">
          <div class="content-header-left col-md-6 col-xs-12 mb-1">
            <h2 class="content-header-title">Advertisement</h2>
          </div>
...
<section id="basic-form-layouts">
	...
	<div class="row match-height" style="font-size: 15px">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form-center">Advertisement</h4>
				...
				<div class="card-body collapse in">
					<div class="card-block">
                        <strong>
                                ...
                                <label for="eventInput1">Advertisement Name</label>
                                           
                                <input type="text" class="form-control" name="adv_name" id="contact-name" placeholder="Enter Name">
                            </div>
                            <div class="form-group">
                                 <label for="eventInput1">Advertisement description</label>
                                <input type="text" class="form-control" name="adv_desc" id="contact-number" placeholder="Your Phone">
                            </div>
                            <div class="form-group">
                                 <label for="eventInput1">Company Name</label>
                                <input type="text" class="form-control" name="company_name" id="contact-email" placeholder="Your Email">
                            </div>
                            <div class="form-group">
                                 <label for="eventInput1">Company Description</label>
                                <textarea class="form-control" name="company_desc" id="message" cols="30" rows="10" placeholder="Your Message"></textarea>
                            </div>
                             <div class="form-group">
                                 <label for="eventInput1">Company Address</label>
                                <input type="text" class="form-control" name="company_address" id="contact-email" placeholder="Your Email">
                            </div>
                             <div class="form-group">
                                 <label for="eventInput1">Company Website</label>
                                <input type="text" class="form-control" name="company_website" id="contact-email" placeholder="Your Email">
                            </div>
                                <div class="form-group">
                                    <label>company logo</label>
                                    <label id="projectinput7" class="file center-block">
                                        <input type="file" id="file" name="c_logo" />
                                        <span class="file-custom"></span>
                                    </label>
                                </div>
                                <div class="form-group">
                                 <label for="eventInput1">Status</label>
                                <input type="text" class="form-control" name="status" id="contact-email" placeholder="Your Email">
                            </div>
                            <div class="form-group">
                                 <label for="eventInput1">Post Date</label>
                                <input type="date" class="form-control" name="post_date" id="contact-email" placeholder="Your Email">
                            </div>
