...
if(isset($_POST['b1']))
    {
        ...
        {
            $fa_id=$checkbox[$i];
            mysqli_query($cn,"DELETE FROM CATEGORY WHERE cat_id='".$fa_id."'");    
        }
    }
  }
?>
...
function catdel(id)
{
    if (window.XMLHttpRequest) {
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                document.getElementById("catdel").innerHTML = this.responseText;
             }
        };
        xmlhttp.open("GET","cat_ajax_del.php?row_id="+id,true);
        xmlhttp.send();
}
</script>
  </head>
  <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
    ...
    <div class="app-content content container-fluid">
      <div class="content-wrapper">
        ...
        <div class="content-body"  id="catdelete"><!-- Basic form layout section start -->
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" id="basic-layout-form-center">Delete Category</h4>
        ...
        <div class="card-body collapse in">
          <div class="card-block" id="catdel">
           <form name="f1" method="post" enctype="multipart-data" action="">
                        <table class="table table-dark table-hover" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <input type="submit" class="btn btn-danger" name="b1" value="Delete" />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
