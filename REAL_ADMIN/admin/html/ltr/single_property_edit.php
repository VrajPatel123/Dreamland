...
$result3=mysqli_fetch_array(mysqli_query($cn,"select * from property_master pm ,property_detail pd where pm.prop_id=pd.prop_id and pm.prop_id=$no and email_id='$email_id'"));
  ...
  if(isset($_POST['b1']))
  {
    ...
    echo "updated";  
     header('location:single_property_view.php');
  }
}
?>
          ...
          <div class="card-block">
            ...
            <form class="form" method="post" name="f1" action="" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  ?>
                  <option value="<?php echo $r[0];?> selected= 
                    <?php 
                    if($r[0]==$result3[2]) 
                    { 
                      echo 'selected';    
              ...
              <div class="form-body">
                    <div class="form-group">
                      ...
                      <input type="text" id="price" class="form-control" placeholder="Enter Price" name="price" value="<?php echo $result3[14]; ?>" />
              </div>
              </div>
