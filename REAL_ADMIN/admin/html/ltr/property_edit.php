...
$result3=mysqli_fetch_array(mysqli_query($cn,"select * from property_master pm ,property_detail pd where pm.prop_id=pd.prop_id and pm.prop_id=$no"));
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title" id="basic-layout-form-center">Update Property</h4>
            ...
            <form class="form" method="post" name="f1" action="" enctype="multipart/form-data">
                ...
                <div class="form-body">
                    <div class="form-group">
                      ...
                      <input type="text" id="id" class="form-control" readonly="readonly" placeholder="Enter property name" name="prop_id" value="<?php echo $result3[0]; ?>" />
              </div>
            </div>
                ...
                <div class="form-group">
                  ...
                  <label id="projectinput7" class="file center-block" required="select name" >
                  <select name="area">
                ...
                <div class="row">
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <select id="projectinput5" name="post_by" class="form-control" required="">
              ...
              <div class="form-body">
                    <div class="form-group">
                      ...
                      <input type="text" id="pname" class="form-control" required title="Please enter name" pattern="[A-z a-z]*" placeholder="Enter property name" name="pname" value="<?php echo $result3[6]; ?>">
              </div>
              </div>
                  ...
                  <label>Photo 1</label>
                  <label id="projectinput7" class="file center-block">
                  <input type="file" id="file" name="p1" required title="Select Photo1">
              ...
              <div class="form-group">
                  <label>Photo 2</label>
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file" name="p2" required title="Select  Photo2">
                ...
                <div class="form-group">
                  <label>Photo 3</label>
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file" name="p3" required title="Select Photo3">
                ...
                <div class="form-group">
                  <label>Photo 4</label>
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file" name="p4" required title="Select Photo4" >
                ...
                <div class="form-group">
                  <label>Photo 5</label>
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file" name="p5" required title="Select Photo5" >
                ...
                <div class="form-group">
                  ...
                  <textarea id="projectinput4" rows="5" class="form-control" required title="Enter Farmer Address" pattern="[ a-z A-Z 0-9 ,-]*" name="address" placeholder="Address"  value=""><?php echo $result3[13]; ?></textarea>
                </div>
              ...
              <div class="form-body">
                    <div class="form-group">
                      ...
                      <input type="text" id="price" class="form-control" required="price" placeholder="Enter Price" name="price" value="<?php echo $result3[14]; ?>" />
              </div>
              </div>
              ...
              <div class="form-body">
                    <div class="form-group">
                      ...
                      <input type="text" id="price" class="form-control" required="enter sqare foot"  placeholder="Enter Sqare foot" name="sqft" value="<?php echo $result3[15]; ?>">
              </div>
              </div>
              ...
              <div class="row">
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <select id="projectinput5" name="bedrooms" class="form-control" required="select">
              ...
              <div class="row">
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <select id="projectinput5" name="parking" class="form-control" required="select">
              ...
              <div class="row">
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <select id="projectinput5" name="bathrooms" class="form-control" required="select bathrooms">
                ...
                <div class="form-group">
                  ...
                  <div class="position-relative has-icon-left">
                    <input type="date" id="timesheetinput3" class="form-control"  required title="Enter Valid Date" name="buildyear" value="<?php echo $result3[19]; ?>">
              ...
              <div class="row">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="radio" name="ac" class="custom-control-input"  required title="select option" value="yes" <?php if($result3[21]=="yes") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                    <input type="radio" name="ac"  class="custom-control-input" required title="select option"  value="no" <?php if($result3[21]=="no") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="clubhouse" class="custom-control-input" required title="select option" value="yes"  <?php if($result3[22]=="yes") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="clubhouse"  class="custom-control-input" required title="select option" value="no" <?php if($result3[22]=="no") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="cityview" class="custom-control-input" required title="select option" value="yes"  <?php if($result3[23]=="yes") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="cityview"  class="custom-control-input" required title="select option" value="no" <?php if($result3[23]=="no") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="intercom" class="custom-control-input" required title="select option" value="yes"   <?php if($result3[24]=="yes") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="intercom"  class="custom-control-input" required title="select option" value="no" <?php if($result3[24]=="no") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="internet" class="custom-control-input" required title="select option" value="yes"  <?php if($result3[25]=="yes") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="internet"  class="custom-control-input" required title="select option" value="no" <?php if($result3[25]=="no") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                       <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="laundryroom" class="custom-control-input" required title="select option" value="yes"  <?php if($result3[26]=="yes") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="laundryroom"  class="custom-control-input" required title="select option" value="no" <?php if($result3[26]=="no") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="erange" class="custom-control-input" required title="select option"  value="yes"  <?php if($result3[27]=="yes") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="erange"  class="custom-control-input" required title="select option" value="no" <?php if($result3[27]=="no") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="gas" class="custom-control-input" required title="select option" value="yes"  <?php if($result3[28]=="yes") { ?> checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="gas"  class="custom-control-input" required title="select option"  value="no" <?php if($result3[28]=="no") { ?>  checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <label class="display-inline-block custom-control custom-radio ml-1">
                      <input type="radio" name="swimmingpool" class="custom-control-input" required title="select option" value="yes"  <?php if($result3[29]=="yes") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">Yes</span>
                    </label>
                    <label class="display-inline-block custom-control custom-radio">
                      <input type="radio" name="swimmingpool" class="custom-control-input" required title="select option" value="no" <?php if($result3[29]=="no") { ?>checked="checked"<?php } ?> />
                      <span class="custom-control-indicator"></span>
                      <span class="custom-control-description ml-0">No</span>
                    </label>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file" name="floorimage" required title="Select image">
                ...
                <div class="form-group">
                  <label>video</label>
                  <label id="projectinput7" class="file center-block">
                    <input type="file" id="file"name="video" required title="Select video">
                ...
                <div class="form-group">
                  ...
                  <label id="projectinput7" class="file center-block">
                     ...
                     <input type="file" id="file" name="locationimg" required title="Select image/>
                ...
                <div class="row">
                  <div class="col-md-5">
                    <div class="form-group">
                      ...
                      <select id="projectinput5" name="floor" class="form-control" required="select floor">
