...
else
{
  ...
  $productResult = $db_handle->runQuery("select * from category");
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-header">
          <h4 class="card-title" id="basic-layout-form-center">View Category</h4>
      ...
      <td ><input type="button" name="b2" value="delete" onClick="catdel('<?php echo $r[0];?>')"></td>
       <td ><a href="category_edit.php?id=<?php echo $r[0]; ?>"><input type="button" name="b1" value="update" /></a></td>
              <td> <?php echo $r[0]; ?> </td>
              <td> <?php echo $r[1]; ?> </td>
              <td> <?php echo $r[2]; ?> </td>
             </tr>
