                        ...
                        <div style="float: right;">
                            ...
                            if(!isset($_SESSION['email'])) 
                            {
                                ...
                                <ul>
                                    ...
                                    <li style="float: left;display: inline-block;"><a href="REAL_ADMIN/admin/html/ltr/admin_login.php" style="color: #fff;padding: 7px 12px;line-height: 30px;font-size: 12px;background: #f4364f;background: linear-gradient(to bottom,#f4364f,#dc2039);">Sign In</a>
                                    </li>
                                <li style="float: left;display: inline-block;"><a href="user_registration.php" style="color: #fff;padding: 7px 12px;line-height: 30px;font-size: 12px;background: #2d5d73;">Sign Up</a>
                                </li>
                                ...
                                <li><a href="#">Mega Menu</a>
                                    <div class="megamenu">
                                        ...
                                        <ul class="single-mega cn-col-4">
                                            ...
                                            <li><a href="land.php?type=land">Land</a></li>
                                            <li><a href="villa.php?type=villa">Villa</a></li>
                                            <li><a href="flat.php?type=flatePla">Flat</a></li>
