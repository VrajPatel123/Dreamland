            ...
            <div class="row">
                ...
                <!-- Single Featured Property -->
                            ...
                            <?php
                              ...
                              $result=mysqli_query($cn,"select * from property_master pm,area a, category c,builder b,property_detail pr where pm.prop_id=pr.prop_id and a.area_id=pm.area_id and c.cat_id=pm.cat_id and b.builder_id=pm.builder_id");
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50">
                        ...
                        <div class="property-thumb">
                              ...
                              <a href="single_buysale.php?no=<?php echo $r[0]; ?>"> <img src="img\bg-img\home\<?php echo $r[21]; ?>"  alt="">
