    ...
    <header class="header-area">
       ...
       <div class="top-header-area">
            <div class="h-100 d-md-flex justify-content-between align-items-center">
                ...
                <div class="email-address">
                    <button class="btn"><a href="user_login.php">SignIn</a></button>
                    <button class="btn"><a href="user_registration.php">Signup</a></button>
                </div>
            </div>
        </div>
...
where pm.prop_id=pr.prop_id and a.area_id=pm.area_id and c.cat_id=pm.cat_id and b.builder_id=pm.builder_id and cat_name='home' ");
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50">
                        ...
                        <div class="property-thumb">
                           <a href="single_home.php?no=<?php echo $r[0]; ?>"> <img src="img\bg-img\home\<?php echo $r[21]; ?>"  alt="">
                            <div class="tag">
                                <span>For Sale</span>
                            </div>
