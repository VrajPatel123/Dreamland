...
from property_master pm,property_detail pr,agent ag
where pm.prop_id=pr.prop_id and ag.email_id=pm.email_id and ag.agent_id=$id ");
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50">
                        ...
                        <div class="property-thumb">
                           <a href="single_agent_property.php?no=<?php echo $r[0]; ?>"> <img src="img\bg-img\home\<?php echo $r[8]; ?>"  alt="">
                            <div class="tag">
                                <span>For Rent</span>
                            </div>
